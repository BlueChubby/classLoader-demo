package com.itranswarp.scan.summer.io;
...
import org.xlm.spring.ResourceResolver;
...
public class ResourceResolverTest {
    ...
    public void scanJar() throws Exception {
        Class<PostConstruct> postConstructClass = PostConstruct.class;
        String pkg = postConstructClass.getPackageName();
        ResourceResolver rr = new ResourceResolver(pkg);
        List<String> classes = rr.scan(res -> {
            String name = res.getName();
            if (name.endsWith(".class")) {
